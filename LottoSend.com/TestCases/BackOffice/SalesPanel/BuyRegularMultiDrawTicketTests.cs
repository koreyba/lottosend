...
namespace LottoSend.com.TestCases.BackOffice.SalesPanel
{
    ...
    class BuyRegularMultiDrawTicketTests<TWebDriver> where TWebDriver : IWebDriver, new() 
    {
        ...
        public BuyRegularMultiDrawTicketTests(WayToPay merchant, string lottery)
        {
            ...
            try
            {
                Buy_Regular_Multi_Draw_Ticket(merchant, _lotteryName);
            }
            catch (Exception e)
            {
                _setUpFailed = true;
       ...
       // [TestCase(2)]
        ...
        /// </summary>
        public void Buy_Regular_Multi_Draw_Ticket(WayToPay merchant, string lottery)
        {
